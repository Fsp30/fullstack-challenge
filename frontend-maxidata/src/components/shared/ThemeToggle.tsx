...
export function ThemeToggle() {
  ...
  return (
    <div className=" flex justify-center items-center dark:bgdark">
      <button
        onClick={toggleTheme}
        className="h-12 w-12 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-700"
      >
        <svg
          className={`fill-violet-700 ${theme === 'light' ? 'block' : 'hidden'}`}
          fill="currentColor"
          viewBox="0 0 20 20"
        >
        ...
        <svg
          className={`fill-yellow-500 ${theme === 'dark' ? 'block' : 'hidden'}`}
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
            ...
            1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 
            2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 
            0v-1a1 1 0 011-1zM5.05 
            6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 
            1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 
            01-1.414-1.414l.707-.707a1 1 0 011.414 
            1.414zM4 11a1 1 0 100-2H3a1 1 0 000 
            2h1z"
          />
        </svg>
      </button>
