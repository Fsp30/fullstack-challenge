  ...
  if (isError) {
    return (
      <div className="text-red-500">
        ...
        <button
          onClick={() => refetch()}
          className="mt-2 text-sm bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded"
        >
          Tentar novamente
        </button>
      </div>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-zinc-600 dark:text-zinc-300">
                    {professional.typeProfessional.describe}
                  </p>
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-4 mt-6">
          <button
            ...
            className="px-4 py-2 bg-zinc-300 dark:bg-zinc-700 rounded disabled:opacity-50"
          >
            Anterior
          </button>
