        ...
        return (
                        <div className="p-4 max-w-2xl mx-auto">
                                ...
                                <ul className="space-y-2 mb-6">
                                        {data.map((data) => (
                                                <li key={data.id} className="border rounded p-2 shadow-sm">
                                                        <div className="flex justify-between items-center">
                                                                <div>
                                                                        <p className="text-sm text-gray-500">ID: {data.id}</p>
                                                                        <p className="font-medium">{data.name}</p>
                                                                        <p className="font-medium">{data.situation}</p>
                                                                        <p className="font-medium">{data.typeProfessional.describe}</p>
                                                                </div>
                                                                <div className="flex space-x-2">
                                                                        <FetchOneProfessionalButton id={data.id} />
